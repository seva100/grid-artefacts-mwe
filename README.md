...
where `configs/config.py` is your config with the hyperparameters. By default, the logs are saved to wandb (project name "face-evolve").

See `config/config_sample.py` for the possible parameters and their explanations.
